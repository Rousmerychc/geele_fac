...
<body>
    <div>
        <table>
            ...
            <tr>
                <td colspan ="2" class = "titfac"><center>(COMMERCIAL INVOICE)</center></td>
            </tr>
    ...
    <div class = "espacio">
        <table class = "tabla2" >
            ...
            <tr>
                <td class = "datosnegrita">Monenda de la Transacción Comercial:<br> (Commercial Transaction Currency) </td>
        ...
        <table>
            ...
            @foreach($detalle as $d)
                <tr class = " top izq der">
                    ...
                    <td class = "margendatos textoizq">{{number_format($d->precio_unitario_sin,5)}}</td>
            ...
            <tr class = " top izq der">
                ...
                <td  class ="margendatos textoizq datosnegrita">{{number_format($factura->monto_detalle,2)}}</td>
            </tr>
            <tr class = " top izq der">
            ...
            <tr >
                ...
                <td class ="margendatos textoizq datosnegrita top1 bot1 izq1 der1"> {{number_format($factura->monto_detalle,2)}}</td>
            </tr>
            <tr>
                <td colspan ="3"></td>
            ...
            <tr>
                ...
                <td class ="margendatos textoizq datosnegrita top1 bot1 izq1 der1">{{number_format($factura->monto_total,2)}}</td>
            </tr>
        </table>
    </div>
    ...
    <div class = "espacio">
        <table class = "tabla3">
            ...
            <tr>
                <td class = "margendatos">Son : {{$literalb}} (BOLIVIANOS)</td>
            </tr>
            <tr>
