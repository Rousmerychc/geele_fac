...
@section('content')   
<div class ="divpagina">
<form method="POST" action="{{ url('ingreso') }}" autocomplete="off" id ="formulario">
@csrf
<div class ="divpagina">
    <div class ="titulobotonagregar">
        <div><h3 class="titulos"><i class="fas fa-angle-double-right"></i>  INGRESO</h3></div> 
    </div>
    ...
    <div  class="divformulario">
        ...
        <div class ="datosingreso row ">
                ...
                <div class=" form-group col-md-2 labelliquidaciones">
                    ...
                    <input name="fecha" id = "fecha" type="date" class="form-control " value="{{$fecha}}"  required>
                </div>
