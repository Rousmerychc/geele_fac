...
<div class ="divpagina">
    <div class ="titulobotonagregar">
        <div><h3 class="titulos"><i class="fas fa-angle-double-right"></i> NOTA ENTREGA</h3></div>
    ...
    <div  class="divformulario">
        ...
        <div>
            <div class = "datos_fac_nota_venta row">
                    
                    <div class=" form-group col-md-4 labelliquidaciones">
                        <label for="name" class="titulonrofac ">{{ __('Fecha:') }}</label>
                        <input name="fecha" type="date" class="form-control texto_titulo_fecha_nrofac" value="{{$fecha}}" readonly required>
                    </div>
                    ...
                    <div class="form-group col-md-2 labelliquidaciones">
                        <label for="name" class=" titulonrofac">Nro Nota Entrega:</label>
                        <input name="nro_factura" type="number" class="form-control texto_titulo_fecha_nrofac" value ="{{$id_fac->nro_nota_venta +1}}"  readonly required>
                    </div> 
    ...
    <div class="divformulario">
     ...
     <div class="botones_atras_guardar">          
        <div class="botonatras">
            <a class="btn btn-outline-danger" href="{{  action('NotaVentaController@index') }}" role="button">Cancelar &nbsp <i class="fas fa-times"></i></a>
        </div>
...
<div class="modal fade" id="staticBackdrop" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <button type="button" class="btn btn-secondary" id = "boton_cancelar" data-dismiss="modal">CANCELAR</button>
        <button type="button" class="btn btn-primary"   onclick="enviar();" id = "boton_enviar">ACEPTAR</button>
      </div>
    </div>
  </div>
</div>        
