        ...
        <div class ="row ">
            <div class = "datos_fac">
                    ...
                    <div class=" form-group col-md-12 labelliquidaciones">
                        ...
                        <input name="fecha" type="date" class="form-control " value="{{$fecha}}" readonly required>
                    </div>

                    <div class="form-group col-md-12 labelliquidaciones">
                        <label for="name" class=" titulonrofac">Sucursal:</label>
                        <input name="sucursal" type="text" class="form-control texto_titulo_fecha_nrofac"  value ="{{$sucu->descripcion}}" readonly required>
                    </div>

                    <div class="form-group col-md-12 labelliquidaciones">
                        <label for="name" class=" titulonrofac">Nro Factura:</label>
                        <input name="nro_factura" type="number" class="form-control texto_titulo_fecha_nrofac" value ="{{$id_fac->id_factura +1}}"  readonly required>
                    </div> 
            ...
            <div class = "row cliente_fac">
                <div class="form-group col-md-12 labelliquidaciones">
                    ...
                    <select name="id_tipo_documento" id = "id_tipo_documento" type = "number" class="form-control" required>
                        <option value=""></option>
                ...
                <div class="form-group col-md-8 labelliquidaciones">
                        ...
                        <input name="nro_documento" id="nro_documento" type="text" class="form-control " onblur="validarnit()" required>
                ...
                <div class="form-group col-md-4 labelliquidaciones">
                    ...
                    <input name="complemento" type="text" class="form-control " id = "complemento"readonly required>
                </div>
                ...
                <div class="form-group col-md-12 labelliquidaciones">
                    ...
                    <input id="email" id = "email" type="email" class="form-control @error('email') is-invalid @enderror" name="email"  required autocomplete="email">
                </div>
            </div>            
            
            <div  class = " row cliente_fac1">
                <div class="form-group col-md-12 labelliquidaciones">
                    <label for="name">{{ __('Tipo de Pago:') }}</label>
                    <select name="id_tipo_pago" id="id_tipo_pago"type = "number" class="form-control" required>
                        <option value=""></option>
                ...
                <div class="form-group col-md-6 labelliquidaciones">
                        ...
                        <input name="nro_tarjeta" id = "nro_tarjeta" type="text" class="form-control "  value = "" readonly requiredrequired>
                </div>
                <div class="form-group col-md-6 labelliquidaciones">
                    <label for="name">&nbsp;</label>
                    <input name="nro_tarjeta2" id = "nro_tarjeta2" type="text" class="form-control " value = "" readonly required  required>
                </div>
                <div class="form-group col-md-12 labelliquidaciones">
                    <label for="name">Codigo CAFC - Nro de Facturas Permitidas 1000</label>
                    <input type="text" name = "codigo_cafc"class="form-control " value = "{{$codigo_cafc->codigo_cafc}}" readonly>
                </div>
                <div class="form-group col-md-12 labelliquidaciones">
                    <label for="name">Cantidad Facturas Emitidas con CAFC</label>
                    <input type="text" class="form-control " value = "{{$codigo_cafc->nro_cafc_emitidas}}" readonly>
                </div>
            </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" id = "boton_cancelar">CANCELAR</button>
    ...
    $.ajax({
         ...
         data:parametros
          ...
          for (var x = 0; x < arreglo.prueba.length; x++){
            ...
            var linea42 = '<td class = "padding_tabla"><input style="width : 120px; "type="double" class = "alinacionderecha1 input_uni_subt_fac preciounitario" id = "precio_unitario'+cont+'" name="precio_uni[]"  onblur="calcula()" value="'+arreglo.prueba[x].precio+'" onkeypress="return (event.charCode >= 46 && event.charCode <= 57)"></td>';
